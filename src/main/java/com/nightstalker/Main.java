...
import com.nightstalker.utility.ProfileManager;
import com.nightstalker.utility.SerializeManager;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Optional.of("Hello").equals(Optional.of("hello")));
